...
void initializeDataReducers(DataReducer* outputReducer, DataReducer* diagnosticReducer) {
   ...
   for (it = P::diagnosticVariableList.begin(); it != P::diagnosticVariableList.end(); it++) {
      ...
      if (P::diagnosticWriteAllDROs || lowercase == "populations_maxdistributionfunction" ||
          lowercase == "populations_vg_maxdistributionfunction") {
         for (unsigned int i = 0; i < getObjectWrapper().particleSpecies.size(); i++) {
      ...
      if (P::diagnosticWriteAllDROs || lowercase == "populations_mindistributionfunction" ||
          lowercase == "populations_vg_mindistributionfunction") {
         for (unsigned int i = 0; i < getObjectWrapper().particleSpecies.size(); i++) {
 ...
 */
bool DataReducer::writeFsGridData(FsGrids& fsgrids, const std::string& meshName, const unsigned int operatorID,
