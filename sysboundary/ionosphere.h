...
namespace SBC {
   ...
   struct SphericalTriGrid {
      ...
      void updateIonosphereCommunicator(dccrg::Dccrg<SpatialCell,dccrg::Cartesian_Geometry>& mpiGrid, fsgrid::FsGrid< FS_STENCIL_WIDTH> & fsgrid); /*!< (Re-)create the subcommunicator for ionosphere-internal communication */
